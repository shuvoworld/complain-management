...
CREATE TABLE `employee`  (
  ...
  `status` enum('engaged','free','on leave') CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `employee` VALUES (2, 'dwa', '012323232323', 'admin@admin.com', NULL, 'engaged');
INSERT INTO `employee` VALUES (3, 'rssdsds', '09877668787', 'admin@admin.com', NULL, 'engaged');
